...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '虎皮椒V3-微信支付',
            'label'   => '<a class="button button-secondary" target="_blank" href="https://admin.xunhupay.com/sign-up/4123.html">申请地址</a> 最新的虎皮椒V3版，微信完美收款，无企业商户资质推荐用此方法完美替代*_* ',
            'default' => false,
        ),
        array(
            'id'         => 'xunhupay',
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '虎皮椒V3-支付宝支付',
            'label'   => '<a class="button button-secondary"  target="_blank" href="https://admin.xunhupay.com/sign-up/4123.html">申请地址</a> 最新的虎皮椒V3版，支付宝完美收款，无企业商户资质推荐用此方法完美替代*_*',
            'default' => false,
        ),
        array(
            'id'         => 'xunhualipay',
    ...
    'fields'      => array(
        ...
        array(
            ...
            'options' => array(
                ...
                // 'custom' => esc_html__('自定义ID排序', 'cao'),
            ),
            'default' => 'id',
            'dependency' => array('is_filter_item_cat', '==', 'true'),
        ),
        // array(
        //     'id'          => 'filter_cat_orderby_custom',
        //     'type'        => 'text',
        //     'title'       => '自定义筛选内页分类排序ID用',
        //     'desc'       => '英文逗号隔开(例：5,2,1,4,3)',
        //     'dependency' => array('is_filter_item_cat_orderby', '==', 'custom'),
        // ),
