...
MP3 Music Player by Sonaar is a very powerful Audio Player for WordPress. It gives you the ability to add unlimited numbers of playlists, albums and audio tracks to any post and custom posts using our Gutenburg block, Elementor Widget or standard shortcodes with tons of attributes. It's very flexible and is compatible with almost every plugins and themes.
...
There is 3 easy ways to use the player. Upload your MP3 file from your page, post or custom post then:
