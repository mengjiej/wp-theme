jQuery(document).ready(function($)
{
  ...
  if(textDomain == 'fwdupt') DEFAULT_SKINS_NR = 1;
  ...
  $("#contextMenuBackgroundColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#contextMenuBorderColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#contextMenuSpacerColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#contextMenuItemNormalColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#contextMenuItemSelectedColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#contextMenuItemDisabledColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#aopwTitleColor").spectrum({
   ...
   $("#thumbnails_preview_background_color").spectrum({
     color: "#5a5a5a",
      chooseText: "Update",
      showInitial: true,
      showInput: true,
  ...
  $("#thumbnails_preview_border_color").spectrum({
     color: "#5a5a5a",
      chooseText: "Update",
      showInitial: true,
      showInput: true,
  ...
  $("#thumbnails_preview_label_background_color").spectrum({
     color: "#5a5a5a",
      chooseText: "Update",
      showInitial: true,
      showInput: true,
  ...
  $("#thumbnails_preview_label_font_color").spectrum({
     color: "#5a5a5a",
      chooseText: "Update",
      showInitial: true,
      showInput: true,
  ...
  $("#atbTimeTextColorNormal").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#atbTimeTextColorSelected").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#atbButtonTextNormalColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#atbButtonTextSelectedColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#atbButtonBackgroundNormalColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#atbButtonBackgroundSelectedColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#scrubbersToolTipLabelBackgroundColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#scrubbersToolTipLabelFontColor").spectrum(
  {
        color: "#5a5a5a",
        chooseText: "Update",
        showInitial: true,
  ...
  $("#lightBoxBackgroundColor").spectrum({
        color: "#888888",
        chooseText: "Update",
        showInitial: true,
        showInput: true,
  ...
  $("#main_button_text_selected_color").spectrum(
  {
    ...
    $("#startBH").val(videoStartBehaviour);
    ...
    $("#enableAutoplayOnMobile").val(settings_obj.enableAutoplayOnMobile);
    ...
    $("#startBH").change(function(){
      if(videoStartBehaviour != $("#startBH").val()){
        $("#update_btn").show();
      }else{
        $("#update_btn").hide();
      }
    ...
    cur_settings_obj.enableAutoplayOnMobile = $("#enableAutoplayOnMobile").val();
    
    cur_settings_obj.loop = $("#loop").val();
    cur_settings_obj.useVectorIcons = $("#useVectorIcons").val();
    cur_settings_obj.googleAnalyticsTrackingCode = $("#googleAnalyticsTrackingCode").val().replace(/"/g, "'");
  ...
  function validateFields(){
    ...
    if($("#name").val() == settingsAr[cur_order_id]["name"]){
      ...
      validateFields();
        ...
        videoStartBehaviour:$("#startBH").val(),
  ...
  var cov_logo_custom_uploader;
    ...
    $("#uvp_logo_image_btn").click(function(e)
    {
        ...
        {
            attachment = cov_logo_custom_uploader.state().get("selection").first().toJSON();
